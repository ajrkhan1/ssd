                            ...
                            <div className="what-did-left-content">
                                ...
                                <div className="col-sm-4">
                                        <div className="choose-card">
                                            <img src="/assets/img/kbnew/clients/duke-energy.jpg" alt="Images" />
                                            <h3>Duke Energy</h3>
                                    ...
                                    <div className="col-sm-4">
                                        <div className="choose-card">
                                            <img src="/assets/img/kbnew/clients/milltronics.jpg" alt="Images" />
                                            <h3>Milltronics</h3>
                                            <div className='row text-center eventsbottomarea2'>
                                                <div className='col-sm-12'>
                                    ...
                                    <div className="col-sm-4">
                                        <div className="choose-card">
                                            <img src="/assets/img/kbnew/clients/eli-lilly-and-company.jpg" alt="Images" />
                                    ...
                                    <div className="col-sm-4">
                                        <div className="choose-card">
                                            <img src="/assets/img/kbnew/clients/aral-germany.jpg" alt="Images" />
                                            <h3>Aral Germany</h3>
                                            <div className='row text-center eventsbottomarea2'>
                                                <div className='col-sm-12'>
                                    ...
                                    <div className="col-sm-4">
                                        <div className="choose-card">
                                            <img src="/assets/img/kbnew/clients/hcl-technologies.jpg" alt="Images" />
                                            <h3>HCL Technologies</h3>
                                            <div className='row text-center eventsbottomarea2'>
                                                <div className='col-sm-12'>
